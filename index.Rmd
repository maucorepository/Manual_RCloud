...
de extensión. Esta solicitud debe realizarse mediante correo electrónico
dirigido al departamento de soporte técnico de MAUCO. En el correo electrónico
de solicitud de extensión, los usuarios deben proporcionar una justificación
clara y detallada sobre la necesidad de prolongar su acceso a RCloud, así como
cualquier información adicional relevante para su solicitud.

El departamento de soporte técnico evaluará cada solicitud de extensión de
manera individual y se esforzará por proporcionar una respuesta oportuna a los
usuarios solicitantes. Se recomienda a los usuarios que anticipen la necesidad
de extender su sesión en RCloud que inicien el proceso de solicitud con
suficiente antelación para garantizar una continuidad sin interrupciones en su
trabajo.